...
## Caveats
  ...
  - <u>System cpu architecture dependent</u>. When you build `Dockerfile`, the earthworm configuration environment file ( `ew_linux.bash` or `ew_linux_arm.sh`) is automatically selected depending if your system is based on ARM or not.
