...
check_for_running: check_docker_variables check_ew_env_variables check_ew_env_subdirs check_container_is_not_running check_container_is_not_running_on_the_same_ew_env
