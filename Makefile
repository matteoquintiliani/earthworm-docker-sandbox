...
help:
	...
	@echo "                        Example: make create_ew_env_from_git_repository GITREP=git@gitlab.rm.ingv.it:earthworm/run_configs.git GIT_BRANCH=develop EW_ENV=my_test_env"
	...
	@echo "                        Pass arguments by ARGS variable "
	@echo "                        Example: make create_ew_env_from_ingv_runconfig_branch GITREP=git@gitlab.rm.ingv.it:earthworm/run_configs.git GIT_BRANCH=hew10 EW_ENV=hew10_testdir"
	@echo ""
