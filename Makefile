...
# Docker EW_INSTALL_HOME
DOCKER_EW_INSTALL_HOME="/opt"
# Docker EW_RUN_DIR
DOCKER_EW_RUN_DIR=$(DOCKER_EW_INSTALL_HOME)/ew_env

# Set Default Volume Mounts
DOCKER_VOLUMES = $(DOCKER_VOLUMES_ADDONS) \
...
version:
	@echo "\
Earthworm Docker Sandbox $(EDS_VERSION) Copyright (C) 2020-2023  Matteo Quintiliani\
"
...
build: _check_for_building
	...
	docker build -t $(DOCKER_IMAGE_NAME_VERSION) \
		...
		--build-arg EW2OPENAPI_GIT_REF=$(EW2OPENAPI_GIT_REF)  \
